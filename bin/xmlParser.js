function XMLParser() {
    ...
    this._encodeCDATAValues = (xmlText) => {
    ...
    this._getElementsByTagName = (tagName) => {
        var matches = [];
    ...
    this._convertTagsArrayToTree = (xml) => {
        var xmlTree = [];
